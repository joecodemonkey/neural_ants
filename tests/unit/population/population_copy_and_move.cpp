...
TEST_CASE("Population copy and move operations", "[population]") {
  ...
  SECTION("Copy constructor") {
    ...
    REQUIRE(copy.get_size() == 5);
    REQUIRE(copy.get_texture_path() == "/test/path.png");
  }
  ...
  SECTION("Copy assignment operator") {
    ...
    REQUIRE(assigned.get_size() == 15);
    REQUIRE(assigned.get_texture_path() == "/another/path.png");
  }
  ...
  SECTION("Self assignment protection") {
    ...
    REQUIRE(population.get_size() == 42);
    REQUIRE(population.get_texture_path() == "/self/path.png");
